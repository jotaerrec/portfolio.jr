  ...
  return (
    <div className="mx:auto">
      ...
      <div className="block top-0 right-0 left-0">
        <div className=" mx-auto ">
          <nav className="nav-pc  lg:flex flex justify-center lg:justify-around  lg:justify-items-stretch  animate__animated animate__backInDown">
            ...
            <div className="logo mt-4 lg:p-2 md:mt-auto lg:ml-4 ">
              <a href="index.html" className="stroke text-5xl md:text-4xl">
                JOTAERRE
              </a>
            </div>
              ...
              <div className="curriculum text-shine font-extrabold">
                <a
                  href={
                    ...
                    "/pdf/Curriculum-Javier_Rodriguez.pdf"
                  }
        ...
        <div className="flex w-screen items-center justify-center flex-col md:flex-row lg:mb-12 lg:mt-36 animate__animated animate__fadeInLeft">
          <div className="present w-min sm:w-max text-white mt-10">
            <p className="font-bold md:font-medium md:m-auto">Hello I'm </p>
            <div className="name-box ml-6">
              <h2 className="name block stroke text-5xl -mb-1.5 ">
                Javier Rodriguez
              </h2>
              <h2 className="name block text-5xl ">Javier Rodriguez</h2>
              <h2 className="name block stroke text-5xl -mt-1.5 ">
                Javier Rodriguez
              </h2>
            </div>
            <p className="textpro md:ml-96 mt-2 font-black text-xl">
